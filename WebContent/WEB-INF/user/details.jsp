        ...
        <div class="white-box">
          <div class="user-bg">
            <img width="100%" alt="user"
              src="<c:url value="/static/plugins/images/large/img1.jpg"></c:url>" />
            <div class="overlay-box">
              <div class="user-content">
                <a href="javascript:void(0)"><img
                  src="<c:url value="/static/plugins/images/users/genu.jpg"></c:url>"
        ...
        <div class="white-box">
          ...
          <div class="message-center">
            <a href="#">
              ...
              <div class="mail-contnet">
                <h5>Sonu Nigam</h5>
                <span class="mail-desc">I've sung a song! See you
