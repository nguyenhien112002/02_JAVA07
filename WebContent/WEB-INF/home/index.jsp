...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href='<c:url value="static/plugins/images/favicon.png"></c:url>'>
    <title>Pixel Admin</title>
    <!-- Bootstrap Core CSS -->
    <link href='<c:url value="/static/bootstrap/dist/css/bootstrap.min.css"></c:url>' rel="stylesheet">
    <!-- Menu CSS -->
    <link href='<c:url value="/static/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.css"></c:url>' rel="stylesheet">
    <!-- toast CSS -->
    <link href='<c:url value="/static/plugins/bower_components/toast-master/css/jquery.toast.css"></c:url>' rel="stylesheet">
    <!-- morris CSS -->
    <link href='<c:url value="/static/plugins/bower_components/morrisjs/morris.css"></c:url>' rel="stylesheet">
    <!-- animation CSS -->
    ...
    <!-- color CSS -->
    <link href='<c:url value="/static/css/colors/blue-dark.css"></c:url>'  id="theme" rel="stylesheet">
...
<body>
            ...
            <div class="navbar-header"> 
                ...
                <div class="top-left-part">
                    <a class="logo" href="index.html">
                        <b>
                            <img src='<c:url value="/static/plugins/images/pixeladmin-logo.png"></c:url>' alt="home" />
                        </b>
                        <span class="hidden-xs">
                            <img src='<c:url value="/static/plugins/images/pixeladmin-text.png"></c:url>' alt="home" />
                        </span>
                    </a>
                </div>
                    ...
                    <li>
                        <div class="dropdown">
                            <a class="profile-pic dropdown-toggle" data-toggle="dropdown" href="#"> 
                                <img src='<c:url value="/static/plugins/images/users/varun.jpg"></c:url>' alt="user-img" width="36" class="img-circle" />
    ...
    <script src="<c:url value="/static/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.js"></c:url>"></script>
    <!--slimscroll JavaScript -->
    <script src="<c:url value="/static/js/jquery.slimscroll.js"></c:url>"></script>
    <!--Wave Effects -->
    <script src="<c:url value="/static/js/waves.js"></c:url>"></script>
    <!--Counter js -->
...
</html>eta http-equiv="Content-Type" content="text/html; charset=UTF-8">
